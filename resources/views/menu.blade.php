            ...
            <div id="horizontal-alignment-1" role="tabpanel" aria-labelledby="horizontal-alignment-item-1">
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4">
                    @foreach(range(1, 10) as $i)
                        <div
                            class="relative w-full max-w-[200px] mx-auto bg-white rounded-xl shadow hover:scale-[1.02] transition duration-150">
                            {{-- Badge --}}
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach(range(1,4) as $i)
                <div
                    class="max-w-xs mx-auto rounded-lg bg-white p-4 shadow hover:scale-105 hover:shadow-md transition duration-150">
                    <img
                    ...
                    <div class="inline-flex rounded-lg shadow-2xs ml-4">
                        <button type="button"
                                class="py-2 px-3 inline-flex justify-center items-center gap-2 first:rounded-l-lg text-sm font-medium border border-gray-200 bg-white text-gray-800 hover:bg-gray-50 focus:outline-none"
                                aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-scale-animation-modal"
                                data-hs-overlay="#hs-scale-animation-modal">
                            View Item
                        </button>
                        <button type="button"
                                class="py-2 px-3 inline-flex justify-center items-center gap-2 last:rounded-r-lg text-sm font-medium border border-gray-200 bg-white text-gray-800 hover:bg-gray-50 focus:outline-none"
                                aria-label="Quick View">
