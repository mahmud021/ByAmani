<section class="bg-[#fbfaf9] py-20" style='font-family: "Raleway", sans-serif;'>
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-12">
            <p class="text-[#965b31] text-sm font-semibold uppercase tracking-wider mb-2">Shop by Category</p>
            <h2 class="text-4xl text-[#181510]" style='font-family: "Playfair Display", serif;'>Crafted for Every Corner</h2>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4">
            ...
            <div class="md:col-start-1 md:row-start-2 relative overflow-hidden rounded-2xl shadow-lg group">
                <img src="https://images.pexels.com/photos/32396741/pexels-photo-32396741.jpeg?auto=compress&cs=tinysrgb&w=800"
